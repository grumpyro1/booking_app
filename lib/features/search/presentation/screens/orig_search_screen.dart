...
class OriginalSearchScreen extends ConsumerStatefulWidget {
  const OriginalSearchScreen({super.key});

  @override
  ConsumerState<OriginalSearchScreen> createState() => _OriginalSearchScreenState();
}

class _OriginalSearchScreenState extends ConsumerState<OriginalSearchScreen> {
